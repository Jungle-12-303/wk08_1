...
| 파트 | 발표자 | 테마 | 커버 L 노드 | 질문 수(약) |
|------|--------|-----|------------|------------|
| A | 최현진 | 네트워크 하드웨어 & 커널 송신 경로 | L2-6, L9, L10, L15 | 24 |
| B | 정범진 | 프로토콜 스택 (주소·연결·Handshake) | L3-2~3, L4-2~6, L8-4~8 | 22 |
| C | 이우진, 이호준 | 웹 서버 구축 & 동시성 | L6, L7-4~7, L12-2~4, L14, L16, L17 | 40 |
| D | 홍윤기 | OS 기반 (FD·프로세스·메모리) | L5, L18, L19, L20 | 31 |
| 공동 | 전원 | CSAPP 11 전체 흐름 (교집합) | L1, L2-1~5, L3-1/4, L4-1, L7-1~3, L8-1~3, L11, L12-1/5, L13 | 29 |
